...
- Contribute to commitlint-config repositories on [GitHub](https://github.com/hadenlabs/commitlint-config). See [GitHub Flow](./contribute/github-flow.md).
...
Documentation is a part of the commitlint-config code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://github.com/hadenlabs/commitlint-config). This means that the contribution process is the same for both the source code and documentation.
