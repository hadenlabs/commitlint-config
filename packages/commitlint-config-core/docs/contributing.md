...
Contributions to commitlint-config-core are welcome.
...
In general, PRs are welcome. We follow the typical "fork-and-pull" [Github Flow](/docs/contribute/github-flow.md).

1. **Fork** the repo on GitHub
2. **Clone** the project to your own machine
3. **Commit** changes to your own branch using [Github Flow](/docs/contribute/github-flow.md)
...
Documentation is a part of the commitlint-config-core code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://gitlab.infosisglobal.com/starter-kit/plop-generator-terraform). This means that the contribution process is the same for both the source code and documentation.
